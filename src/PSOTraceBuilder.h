...
public:
  ...
  virtual void store(const SymData &ml) override;
  virtual void atomic_store(const SymData &ml) override;
  virtual void compare_exchange
  (const SymData &sd, const SymData::block_type expected, bool success) override;
  virtual void load(const SymAddrSize &ml) override;
  virtual void full_memory_conflict() override;
  virtual void fence() override;
  virtual void join(int tgt_proc) override;
  virtual void mutex_lock(const SymAddrSize &ml) override;
  virtual void mutex_lock_fail(const SymAddrSize &ml) override;
  virtual void mutex_trylock(const SymAddrSize &ml) override;
  virtual void mutex_unlock(const SymAddrSize &ml) override;
  virtual void mutex_init(const SymAddrSize &ml) override;
  virtual void mutex_destroy(const SymAddrSize &ml) override;
  virtual bool cond_init(const SymAddrSize &ml) override;
  virtual bool cond_signal(const SymAddrSize &ml) override;
  virtual bool cond_broadcast(const SymAddrSize &ml) override;
  virtual bool cond_wait(const SymAddrSize &cond_ml, const SymAddrSize &mutex_ml) override;
  virtual bool cond_awake(const SymAddrSize &cond_ml, const SymAddrSize &mutex_ml) override;
  virtual int cond_destroy(const SymAddrSize &ml) override;
  virtual void register_alternatives(int alt_count) override;
